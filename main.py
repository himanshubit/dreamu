...
PRESETS = {
    "trend_flux": {"label": "Flux Raw", "category": "Trending", "prompt": "masterpiece, best quality, ultra detailed, amateur smartphone photo, authentic film grain, slight motion blur, harsh flash, candid moment, unedited, raw aesthetic, 4k, highly detailed skin texture, HDR."},
    "trend_lomo": {"label": "Lomo", "category": "Trending", "prompt": "masterpiece, best quality, highly detailed, lomography style, oversaturated colors, heavy vignette, high contrast, cross-processing effect, leaky light, nostalgic 2010s instagram aesthetic."},
    ...
    "anim_japan": {"label": "Anime", "category": "Anime", "prompt": "masterpiece, best quality, highly detailed, modern Japanese anime key visual, Kyoto Animation style, sharp outlines, cel shading, vibrant colors, intricate eyes, cinematic lighting, high quality 2D animation, 4k, 8k uhd."},
    "photo_fisheye": {"label": "Fisheye", "category": "Photo", "prompt": "masterpiece, best quality, ultra realistic, ultra-wide fisheye lens distortion, 8mm skate video aesthetic, barrel distortion, close-up focus, dynamic perspective, vignette borders, highly detailed."},
    "photo_macro": {"label": "Macro", "category": "Photo", "prompt": "masterpiece, best quality, 8k uhd, extreme macro photography, microscopic details, water droplets, compound eyes, razor sharp focus, creamy bokeh background, scientific imaging, hyper-detailed."},
    ...
    "art_oil": {"label": "Oil Paint", "category": "Art", "prompt": "masterpiece, best quality, highly detailed, thick impasto oil painting, visible palette knife strokes, vibrant swirling colors, Van Gogh influence, textured canvas, expressive technique, traditional art, fine art."},
